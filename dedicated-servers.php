...
<html lang="en">
  <head>
    ...
    <title>Dedicated Servers - leh</title>
  ...
  <body class="web overlay">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="dedicated-servers.php">Dedicated</a></li>
    ...
    <div class="container h">
      <h1 class="animated bounceInLeft"><span>Dedicated </span> Servers<p></h1>
